; WeatherSystem Plugin Installer
...
!define VERSION "0.1"
Name "WeatherSystem Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_WeatherSystem_${VERSION}.exe"
...
; Sections
Section "WeatherSystem" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\WeatherSystem"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\WeatherSystem\Plugin_WeatherSystem.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\WeatherSystem\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\WeatherSystem"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\WeatherSystem\Plugin_WeatherSystem.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\WeatherSystem\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_WeatherSystem"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_WeatherSystem\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "WeatherSystem Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2014, The authors of the WeatherSystem Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "WeatherSystem Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_WeatherSystem\changelog.md"'
FunctionEnd
